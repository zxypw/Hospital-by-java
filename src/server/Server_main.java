      ...
      class ServerThread implements Runnable{
    	  ...
    	  public void run()
    	  {
    		  try{
    			  ...
    			  String cli=is.readLine();
    			  System.out.println("客户端: "+cli);
    			...
    			//  while(inputString!=null&&!inputString.trim().equals("quit")){
    			  ...
    			  //if ()inputString="";//如果错误则返回空值
    			  //medi=123;
    			  if (cli.equals("chayao")){inputString=String.valueOf(medi);}
    			  if (cli.equals("jiayao")){medi=medi+1;}
